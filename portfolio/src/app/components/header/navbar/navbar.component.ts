...
@Component({
  ...
  template: `
    <nav class="flex">
      <!-- Desktop Navigation -->
      <div class="hidden md:flex space-x-6 mt-0.5">
        <a *ngFor="let item of navItems" 
           [href]="item.href"
           class="font-bold text-gray-500 dark:text-gray-300 hover:text-blue-800 dark:hover:text-yellow-600 transition-colors">
          {{item.label}}
        </a>
      </div>
      ...
      <button 
        ...
        class="md:hidden p-2 rounded-md mt-1 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800">
